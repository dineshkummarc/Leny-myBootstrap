  <head>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/download-6.jpg)" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-10em">
						<div class="col-md-10 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font" style="color: red">OFFICES!</h1>
							<h2 class="cursive-font" style="color: blue">*National Headquarters!</h2>
							<h2 class="cursive-font" style="color: blue">*Regional Office!</h2>
						</div>
					</div>	
				</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">National Headquarters and Regional Office!!!</h2>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="fh5co-text">
							<h1 class="cursive-font  primary-color">National Headquarters</h1>
							<h2>Command Group</h2>
                            <p>*Office of the Chief, BJMP</p>
                            <p>*Deputy Chief for Administration</p>
                            <p>*Deputy Chief fopr Operations</p>
                            <p>*Chief Directorial Staff</p>
                            <h3>Directorates</h3>
                            <p>*Directorate for Comptrollership</p>
                            <p>*Directorate for Operations</p>
                            <p>*Directorate for Logistics</p>
                            <p>*Directorate for Personnel and Records Management</p>
                            <p>*Directorate for Human Resource Development</p>
                            <p>*Directorate for Investigation and Prosecution</p>
                            <p>*Directorate for Program Development</p>
                            <p>*Directorate for Inmates Welfare and Development</p>
                            <p>*Directorate for Intelligence</p>
                            <h4>Support Services</h4>
                            <p>*Internal Audit Service</p>
                            <p>*Health Service</p>
                            <p>*Finance Service</p>
                            <p>*Program Management Office</p>
                            <p>*Chaplaincy Service</p>
                            <p>*Legal Service</p>
                            <p>*Community Relations Service</p>
                            <p>*Information and Communication Technology Service</p>
                            <p>*Office of the General Services</p>
                            <p>*Office of the National Executive Senior Jail Officer (NESJO)</p>
                            <p>*Accounting Service</p>
                            <p>*Supply Accountable Office</p>
                            <p>*Jail National Training Institute</p>
						</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="fh5co-text">
							<h1 class="cursive-font  primary-color">Regional Office</h1>
							<p>*BJMP Regional Office NCR</p>
                            <p>*BJMP Regional Office I
                            <p>*BJMP Regional Office II
                            <p>*BJMP Regional Office III
                            <p>*BJMP Regional Office IV-A
                            <p>*BJMP Regional Office IV-B
                            <p>*BJMP Regional Office V
                            <p>*BJMP Regional Office VI
                            <p>*BJMP Regional Office VII
                            <p>*BJMP Regional Office VIII
                            <p>*BJMP Regional Office IX
                            <p>*BJMP Regional Office X
                            <p>*BJMP Regional Office XI
                            <p>*BJMP Regional Office XII
                            <p>*BJMP Regional Office XIII (CARAGA)
                            <p>*BJMP Regional Office CAR
                            <p>*BJMP Regional Office ARMM</p>
						</div>
				</div>
